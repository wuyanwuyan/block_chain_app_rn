...
export default class FullScreenCharts extends React.Component {
    ...
    constructor() {
        ...
        this.state = {
            ...
            allzome: {scaleX: 1, scaleY: 1, xValue: 4000, yValue: 1, axisDependency: 'RIGHT'}
        };
    ...
    syncToChart2(event) {
        if (event.action == 'chartScaled' || event.action == 'chartTranslated') {
            ...
            this.setState({
                allzome: {scaleX: scaleX, scaleY: scaleY, xValue: centerX, yValue: centerY,axisDependency: 'RIGHT'}
            })
                ...
                <View style={styles.chartsContainer}>
                    <View style={styles.candleStickContainer}>
                        <CandleStickChart
                            ...
                            // zoom={{scaleX: 2, scaleY: 1, xValue: 4000, yValue: 1, axisDependency: 'RIGHT'}}
                            zoom={this.state.allzome}
                    ...
                    <View style={styles.lineChartContainer}>
                        <CandleStickChart
                            ...
                            autoScaleMinMaxEnabled={true}
                            // zoom={{scaleX: 2, scaleY: 1, xValue:  400000, yValue: 1}}
                            // zoom={{scaleX: 1, scaleY: 1, xValue: 4000, yValue: 1, axisDependency: 'RIGHT'}}
                            zoom={this.state.allzome}
                            onSelect={this.handleSelect.bind(this)}
                            onChange={(event) => this.syncToChart2(event.nativeEvent)}
                        />
